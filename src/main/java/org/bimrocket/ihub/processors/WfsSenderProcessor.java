 ...
 */
public class WfsSenderProcessor extends SenderAbstract
{

    private static final Logger log = LoggerFactory
            .getLogger(WfsSenderProcessor.class);

    // PARAMS
    @ConfigProperty(name = "wfs.url", description = "Url to wfs server")
    String url;

    @ConfigProperty(name = "wfs.layer", description = "Layer to update")
    String layer;

    @ConfigProperty(name = "wfs.xmlns", description = "XML Namespace to update")
    String namespace;

    @ConfigProperty(name = "wfs.xmlns.url", description = "XML URI Namespace to update")
    String namespaceURL;

    @ConfigProperty(name = "wfs.type.name", description = "Wfs entity to update")
    String typeName;

    @ConfigProperty(name = "wfs.auth", description = "Authentication used currently supported only Basic")
    String auth;
    ...
    @ConfigProperty(name = "wfs.petition.timeout", description = "Timeout used to sending to geoserver (if it exceeds timeout then it retries by number of retries set")
    Integer timeout;

    public WfsSenderProcessor(Connector connector)
    {
        super(connector);
    }
